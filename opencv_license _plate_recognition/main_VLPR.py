...
from tkinter import ttk, BOTH, LEFT, TOP, RIGHT
...
class Surface(ttk.Frame):
    ...
    def from_pic(self):
        ...
        self.pic_path = tk.PhotoImage(file='../media/car_imgs/timg4.png')
        # self.pic_path = ImageTk.PhotoImage(Image.open('../media/car_imgs/timg4.png'))
        # path = '../media/car_imgs'
        # self.pic_path = os.listdir(path)
        if self.pic_path:
